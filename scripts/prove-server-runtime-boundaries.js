...
function main() {
  ...
  process.stdout.write("[server runtime boundary proof] summary\n");
  ...
  if (failures.length > 0) {
    process.stderr.write("[server runtime boundary proof] failed\n");
  ...
  process.stdout.write("[server runtime boundary proof] passed\n");
}
