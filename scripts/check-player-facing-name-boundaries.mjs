...
const requiredPatterns = [
  ...
  ['packages/server/src/network/world-sync-player-state.service.ts', /resolvePlayerDisplayName\(player,/, '玩家自身同步必须过滤机器 ID 名称'],
  ...
  ['packages/server/src/runtime/craft/technique-activity-task-view.helpers.ts', /resolvePlayerFacingContentName\(job\.outputItemId, '未知物品'\)/, '技艺任务目标不得显示物品 ID'],
