...
- `world-runtime-formation.service`：阵法维护 job 的 start/queue/cancel/灵力不足中止已改为 strategy result 返回结构化 `notice.craft.formation.*`；布阵、开关、一次性补给、阵法灵力/灵石耗尽等仍属于阵法系统/资源管理路径，仍需后续迁移或确认。
