...
- 生成时间: 2026-04-21T11:34:35.388Z
- 目标服务: http://127.0.0.1:45870
...
| stat-panels | 411 | Hello<br>RequestAttrDetail<br>RequestLeaderboard<br>RequestWorldSummary | AttrDetail<br>Bootstrap<br>InitSession<br>Leaderboard<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta<br>WorldSummary |
| craft-panels | 9458 | CancelAlchemy<br>CancelEnhancement<br>DeleteAlchemyPreset<br>Equip<br>Hello<br>Move<br>RequestAlchemyPanel<br>RequestEnhancementPanel<br>SaveAlchemyPreset<br>StartAlchemy<br>StartEnhancement | AlchemyPanel<br>Bootstrap<br>EnhancementPanel<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| heartbeat-chat | 418 | Chat<br>Heartbeat<br>Hello<br>Ping | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Pong<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| quest-navigation | 208 | Hello<br>NavigateQuest | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>PanelDelta<br>QuestNavigateResult<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| portal-transfer | 410 | Hello<br>UsePortal | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
...
| error-path | 208 | Hello<br>RequestNpcShop | Bootstrap<br>Error<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| inventory-ops | 119 | DestroyItem<br>Hello<br>SortInventory | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| player-controls | 3566 | DebugResetSpawn<br>HeavenGateAction<br>Hello<br>UpdateAutoBattleSkills<br>UpdateAutoBattleTargetingMode<br>UpdateAutoUsePills<br>UpdateCombatTargetingRules<br>UpdateTechniqueSkillAvailability<br>UseItem<br>UsePortal | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| npc-shop | 1041 | BuyNpcShopItem<br>Hello<br>RequestNpcShop<br>UseAction | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>NpcShop<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| npc-detail-quests | 811 | AcceptNpcQuest<br>Hello<br>RequestDetail<br>RequestNpcQuests<br>RequestQuests<br>SubmitNpcQuest<br>UseAction | Bootstrap<br>Detail<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>NpcQuests<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| pending-logbook-ack | 366 | AckSystemMessages<br>Hello | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| redeem-codes | 826 | RedeemCodes | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>PanelDelta<br>Quests<br>Realm<br>RedeemCodesResult<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| gm-next | 776 | GmGetState<br>GmRemoveBots<br>GmResetPlayer<br>GmSpawnBots<br>GmUpdatePlayer<br>Hello | Bootstrap<br>GmState<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| suggestions | 1046 | CreateSuggestion<br>GmMarkSuggestionCompleted<br>GmRemoveSuggestion<br>Hello<br>MarkSuggestionRepliesRead<br>ReplySuggestion<br>RequestSuggestions<br>VoteSuggestion | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| mail | 718 | ClaimMailAttachments<br>DeleteMail<br>Hello<br>MarkMailRead<br>RequestMailDetail<br>RequestMailPage<br>RequestMailSummary | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailDetail<br>MailOpResult<br>MailPage<br>MailSummary<br>MapEnter<br>MapStatic<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| progression-combat | 4451 | CastSkill<br>Cultivate<br>Equip<br>Hello<br>Unequip<br>UseAction<br>UseItem | AlchemyPanel<br>Bootstrap<br>EnhancementPanel<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| loot | 4099 | DropItem<br>Hello<br>Move<br>MoveTo<br>TakeGround | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| market | 3108 | BuyMarketItem<br>CancelMarketOrder<br>ClaimMarketStorage<br>CreateMarketBuyOrder<br>CreateMarketSellOrder<br>DropItem<br>Hello<br>RequestMarket<br>RequestMarketItemBook<br>RequestMarketListings<br>RequestMarketTradeHistory<br>SellMarketItem | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>MarketItemBook<br>MarketListings<br>MarketOrders<br>MarketStorage<br>MarketTradeHistory<br>MarketUpdate<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |

## 客户端到服务端覆盖

| 事件名 | Wire Event | 已覆盖 | 次数 | 总流量 | 平均流量 | 用例 |
| --- | --- | --- | ---: | ---: | ---: | --- |
| Hello | `n:c:hello` | 是 | 26 | 1.37 KB | 54 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>session-kick<br>stat-panels<br>suggestions |
...
| MapStatic | `n:s:mapStatic` | 是 | 36 | 834.90 KB | 23.19 KB | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| Realm | `n:s:realm` | 是 | 33 | 12.21 KB | 379 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| WorldDelta | `n:s:worldDelta` | 是 | 61 | 18.69 KB | 314 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| SelfDelta | `n:s:selfDelta` | 是 | 79 | 4.26 KB | 55 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| PanelDelta | `n:s:panelDelta` | 是 | 77 | 166.48 KB | 2.16 KB | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
...
| Notice | `n:s:notice` | 是 | 39 | 3.38 KB | 89 B | craft-panels<br>heartbeat-chat<br>inventory-ops<br>loot<br>market<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat |
...
| GmState | `n:s:gmState` | 是 | 5 | 9.69 KB | 1.94 KB | gm-next |
...
| --- | --- | --- | ---: | ---: | ---: | --- |
| s2c | MapStatic | `n:s:mapStatic` | 36 | 834.90 KB | 23.19 KB | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| s2c | PanelDelta | `n:s:panelDelta` | 77 | 166.48 KB | 2.16 KB | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| s2c | Bootstrap | `n:s:bootstrap` | 28 | 136.43 KB | 4.87 KB | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| s2c | AlchemyPanel | `n:s:alchemyPanel` | 11 | 123.42 KB | 11.22 KB | craft-panels<br>progression-combat |
| s2c | WorldDelta | `n:s:worldDelta` | 61 | 18.69 KB | 314 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
...
| s2c | Realm | `n:s:realm` | 33 | 12.21 KB | 379 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| s2c | GmState | `n:s:gmState` | 5 | 9.69 KB | 1.94 KB | gm-next |
...
| s2c | SelfDelta | `n:s:selfDelta` | 79 | 4.26 KB | 55 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| s2c | Notice | `n:s:notice` | 39 | 3.38 KB | 89 B | craft-panels<br>heartbeat-chat<br>inventory-ops<br>loot<br>market<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat |
| s2c | MapEnter | `n:s:mapEnter` | 31 | 3.13 KB | 103 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| s2c | MarketOrders | `n:s:marketOrders` | 15 | 2.74 KB | 187 B | market |
| s2c | InitSession | `n:s:initSession` | 28 | 2.03 KB | 74 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| s2c | MailSummary | `n:s:mailSummary` | 32 | 1.91 KB | 61 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| c2s | Hello | `n:c:hello` | 26 | 1.37 KB | 54 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>session-kick<br>stat-panels<br>suggestions |
| s2c | Leaderboard | `n:s:leaderboard` | 1 | 1.23 KB | 1.23 KB | stat-panels |
| s2c | MailPage | `n:s:mailPage` | 1 | 628 B | 628 B | mail |
| s2c | MarketTradeHistory | `n:s:marketTradeHistory` | 3 | 616 B | 205 B | market |
| s2c | Detail | `n:s:detail` | 1 | 585 B | 585 B | npc-detail-quests |
| s2c | MarketItemBook | `n:s:marketItemBook` | 1 | 572 B | 572 B | market |
| s2c | TileDetail | `n:s:tileDetail` | 1 | 538 B | 538 B | bootstrap-runtime |
| s2c | MarketStorage | `n:s:marketStorage` | 15 | 498 B | 33 B | market |
| s2c | LootWindowUpdate | `n:s:lootWindowUpdate` | 28 | 420 B | 15 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
| s2c | Quests | `n:s:quests` | 30 | 390 B | 13 B | bootstrap-runtime<br>craft-panels<br>error-path<br>gm-next<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>redeem-codes<br>session-kick<br>stat-panels<br>suggestions |
...
| c2s | UpdateCombatTargetingRules | `n:c:updateCombatTargetingRules` | 1 | 229 B | 229 B | player-controls |
| c2s | SaveAlchemyPreset | `n:c:saveAlchemyPreset` | 1 | 210 B | 210 B | craft-panels |
| s2c | RedeemCodesResult | `n:s:redeemCodesResult` | 1 | 191 B | 191 B | redeem-codes |
...
| c2s | UseAction | `n:c:useAction` | 3 | 126 B | 42 B | npc-detail-quests<br>npc-shop<br>progression-combat |
...
| c2s | GmMarkSuggestionCompleted | `n:c:gmMarkSuggestionCompleted` | 1 | 55 B | 55 B | suggestions |
| c2s | GmRemoveSuggestion | `n:c:gmRemoveSuggestion` | 1 | 55 B | 55 B | suggestions |
...
| c2s | RedeemCodes | `n:c:redeemCodes` | 1 | 50 B | 50 B | redeem-codes |
