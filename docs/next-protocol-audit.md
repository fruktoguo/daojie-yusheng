...
- 生成时间: 2026-04-16T16:29:41.715Z
- 目标服务: http://127.0.0.1:46554
...
| stat-panels | 408 | Hello<br>RequestAttrDetail<br>RequestLeaderboard<br>RequestWorldSummary | AttrDetail<br>Bootstrap<br>InitSession<br>Leaderboard<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta<br>WorldSummary |
| craft-panels | 7488 | CancelAlchemy<br>CancelEnhancement<br>Equip<br>Hello<br>Move<br>RequestAlchemyPanel<br>RequestEnhancementPanel<br>StartAlchemy<br>StartEnhancement | AlchemyPanel<br>Bootstrap<br>EnhancementPanel<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
...
| npc-detail-quests | 510 | Hello<br>RequestDetail<br>RequestNpcQuests<br>RequestQuests<br>UseAction | Bootstrap<br>Detail<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>NpcQuests<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| pending-logbook-ack | 367 | AckSystemMessages<br>Hello | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
...
| progression-combat | 5192 | CastSkill<br>Cultivate<br>Equip<br>Hello<br>Unequip<br>UseItem | AlchemyPanel<br>Bootstrap<br>EnhancementPanel<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| loot | 4077 | DropItem<br>Hello<br>Move<br>MoveTo<br>TakeGround | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
| market | 3039 | BuyMarketItem<br>CancelMarketOrder<br>ClaimMarketStorage<br>CreateMarketBuyOrder<br>CreateMarketSellOrder<br>DropItem<br>Hello<br>RequestMarket<br>RequestMarketItemBook<br>RequestMarketListings<br>RequestMarketTradeHistory<br>SellMarketItem | Bootstrap<br>InitSession<br>LootWindowUpdate<br>MailSummary<br>MapEnter<br>MapStatic<br>MarketItemBook<br>MarketListings<br>MarketOrders<br>MarketStorage<br>MarketTradeHistory<br>MarketUpdate<br>Notice<br>PanelDelta<br>Quests<br>Realm<br>SelfDelta<br>SuggestionUpdate<br>WorldDelta |
...
| MapStatic | `n:s:mapStatic` | 是 | 488 | 2527.71 KB | 5.18 KB | bootstrap-runtime<br>craft-panels<br>error-path<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>session-kick<br>stat-panels<br>suggestions |
...
| PanelDelta | `n:s:panelDelta` | 是 | 68 | 266.55 KB | 3.92 KB | bootstrap-runtime<br>craft-panels<br>error-path<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>session-kick<br>stat-panels<br>suggestions |
...
| Notice | `n:s:notice` | 是 | 36 | 3.11 KB | 89 B | craft-panels<br>heartbeat-chat<br>loot<br>market<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat |
...
| --- | --- | --- | ---: | ---: | ---: | --- |
| s2c | MapStatic | `n:s:mapStatic` | 488 | 2527.71 KB | 5.18 KB | bootstrap-runtime<br>craft-panels<br>error-path<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>session-kick<br>stat-panels<br>suggestions |
| s2c | Bootstrap | `n:s:bootstrap` | 25 | 1393.18 KB | 55.73 KB | bootstrap-runtime<br>craft-panels<br>error-path<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>session-kick<br>stat-panels<br>suggestions |
| s2c | PanelDelta | `n:s:panelDelta` | 68 | 266.55 KB | 3.92 KB | bootstrap-runtime<br>craft-panels<br>error-path<br>heartbeat-chat<br>inventory-ops<br>loot<br>mail<br>market<br>npc-detail-quests<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat<br>quest-navigation<br>session-kick<br>stat-panels<br>suggestions |
...
| s2c | Notice | `n:s:notice` | 36 | 3.11 KB | 89 B | craft-panels<br>heartbeat-chat<br>loot<br>market<br>npc-shop<br>pending-logbook-ack<br>player-controls<br>portal-transfer<br>progression-combat |
