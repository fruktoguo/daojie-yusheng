...
- `1x` 每小时运行成本为 0。`s >= 2` 时，单位置基础成本为 2 倍速 100 灵石/小时，之后每提升一倍按阶乘递增乘对应倍率（`baseCost(s) = baseCost(s - 1) × s`，即 `2x=100`、`3x=300`、`4x=1200`、`5x=6000`、`6x=36000`、`7x=252000`、`8x=2016000`、`9x=18144000`、`10x=181440000`）。
