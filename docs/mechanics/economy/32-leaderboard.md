...
| 人榜 | 灵石 | 可见灵石 + 未成交求购单预留灵石 + 创建者名下宝库灵石 | `spiritStones` |
...
- 灵石榜按玩家可见灵石、开放求购单中尚未成交的预留灵石，以及其创建的全部宝库内灵石之和排序，避免通过求购锁单或宝库隐藏财富。宝库内灵石无论由谁存入，均归属宝库创建者统计。
...
interface WorldSummary {
  totalSpiritStones: number;      // 全服灵石总量（可见灵石 + 坊市托管灵石 + 未成交求购预留灵石 + 宝库灵石）
  actionCounts: {
