...
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`node dist/tools/world-gateway-attr-detail-helper-smoke.js`、`node dist/tools/world-gateway-client-emit-helper-smoke.js` 与 `node dist/tools/smoke-suite.js --case session --case runtime`；结果通过，说明 gateway 的 attr-detail 读模型抽离与 next emit glue 抽离未打破 session/bootstrap 与 runtime 主链
...
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-gateway-guard-helper`、`pnpm --filter @mud/server smoke:world-gateway-session-state-helper`、`pnpm --filter @mud/server smoke:world-gateway-client-emit-helper` 与 `node packages/server/dist/tools/smoke-suite.js --case session --case runtime`；结果通过，说明 gateway guard/session-state seam 收口未打破 session/bootstrap 与 runtime 主链
...
- 新增 `packages/server/src/tools/world-sync-aux-state-smoke.js` 与 `pnpm --filter @mud/server smoke:world-sync-aux-state`
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-sync-aux-state` 与 `node dist/tools/smoke-suite.js --case session --case runtime`；结果通过，说明 sync aux-state seam 抽离未打破会话/同步主链
...
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-sync-envelope`、`pnpm --filter @mud/server smoke:world-sync-player-state`、`pnpm --filter @mud/server smoke:world-sync-aux-state` 与 `node dist/tools/smoke-suite.js --case session --case runtime`；结果通过，说明 envelope/player-state/aux-state 三层同步边界收口未打破会话/同步主链
...
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-lifecycle` 与 `pnpm --filter @mud/server smoke:runtime`；结果通过，说明 lifecycle seam 收口未打破 runtime 主链
...
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-gm-system-command`、`pnpm --filter @mud/server smoke:world-runtime-system-command` 与 `pnpm --filter @mud/server smoke:runtime`；结果通过，说明 GM system-command seam 收口未打破 runtime 主链
...
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-persistence-state`、`pnpm --filter @mud/server smoke:world-runtime-frame` 与 `pnpm --filter @mud/server smoke:runtime`；结果通过，说明 persistence-state/frame seam 收口未打破 runtime 主链
...
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-world-access`、`pnpm --filter @mud/server smoke:world-runtime-player-session` 与 `pnpm --filter @mud/server smoke:runtime`；结果通过，说明 world-access/player-session seam 收口未打破 runtime 主链
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-read-facade`、`pnpm --filter @mud/server smoke:world-runtime-tick-dispatch` 与 `pnpm --filter @mud/server smoke:runtime`；结果通过，说明 read-facade/tick-dispatch seam 收口未打破 runtime 主链
...
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-gameplay-write-facade`、`pnpm --filter @mud/server smoke:world-runtime-quest-runtime-facade` 与 `pnpm --filter @mud/server smoke:runtime`；结果通过，说明 gameplay-write/quest-runtime seam 收口未打破 runtime 主链
...
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-state-facade`、`pnpm --filter @mud/server smoke:world-runtime-instance-read-facade` 与 `pnpm --filter @mud/server smoke:runtime`；结果通过，说明 state/instance-read seam 收口未打破 runtime 主链
...
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-command-intake-facade` 与 `pnpm --filter @mud/server smoke:runtime`；结果通过，说明 command-intake seam 收口未打破 runtime 主链
...
- `pnpm --filter @mud/server smoke:loot`
...
- `pnpm --filter @mud/server smoke:next-auth-bootstrap`
- `pnpm --filter @mud/server smoke:session`
- `pnpm --filter @mud/server smoke:player-recovery`
...
- 本轮验证已补跑 `smoke:runtime`、`smoke:monster-ai`、`audit:protocol`、根级 `pnpm build` 与 `pnpm verify:replace-ready`
...
- 本轮验证已补跑 `smoke:runtime`、`smoke:progression`、`audit:protocol`、根级 `pnpm build` 与 `pnpm verify:replace-ready`
...
- 本轮验证已补跑 `smoke:next-auth-bootstrap`、`smoke:runtime`、`audit:protocol`、根级 `pnpm build` 与 `pnpm verify:replace-ready`
...
- 本轮验证已补跑 `audit:protocol`、`smoke:progression`、`smoke:redeem-code`、`smoke:gm-next`、根级 `pnpm build` 与 `pnpm verify:replace-ready`
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-npc-shop` 与根级 `pnpm verify:replace-ready`；结果通过，说明 NPC shop view query 抽离未打破 NPC shop 读链与 local replace-ready 证明链
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-npc-shop` 与根级 `pnpm verify:replace-ready`；结果通过，说明 NPC shop purchase validation query 抽离未打破 NPC shop 校验链与 local replace-ready 证明链
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:runtime`、`pnpm --filter @mud/server smoke:player-respawn`、`pnpm --filter @mud/server smoke:gm-next`、根级 `pnpm build` 与 `pnpm verify:replace-ready`；其中 `pnpm build` 因并发清理 `packages/client/dist` 首次触发 Vite `ENOTEMPTY` 后已串行重跑通过，其余验证均直接通过
...
- `pnpm --filter @mud/server build`
- `pnpm --filter @mud/server smoke:progression`
- `pnpm --filter @mud/server smoke:redeem-code`
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-quest-state`、`pnpm --filter @mud/server smoke:progression` 与根级 `pnpm build`；结果通过
- 额外复核：`pnpm --filter @mud/server smoke:combat` 单跑通过，说明 quest-state helper 抽离未破坏相邻 runtime 主链
...
- 本轮验证已补跑 `pnpm build`、`pnpm verify:replace-ready`、`pnpm --filter @mud/server smoke:combat` 与 `pnpm --filter @mud/server smoke:monster-combat`
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:runtime`、`pnpm --filter @mud/server smoke:player-respawn`、`pnpm --filter @mud/server smoke:gm-next`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:runtime`、`pnpm --filter @mud/server smoke:gm-next`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过，其中 `gm-next` 在无库本地口径下返回 `ok: true` 且标记 `skipped`
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-player-location`、`pnpm --filter @mud/server smoke:world-runtime-transfer`、`pnpm --filter @mud/server smoke:world-runtime-npc-access`、`pnpm --filter @mud/server smoke:world-runtime-movement`、`pnpm --filter @mud/server smoke:world-runtime-instance-tick-orchestration`、`pnpm --filter @mud/server smoke:runtime`、`pnpm --filter @mud/server smoke:gm-next`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过，其中 `gm-next` 在无库本地口径下返回 `ok: true` 且标记 `skipped`
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-movement`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:combat`、`pnpm --filter @mud/server smoke:monster-combat`、`pnpm --filter @mud/server smoke:player-recovery`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-use-item`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-item-ground`、`pnpm --filter @mud/server smoke:loot`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
- 新增 `packages/server/src/runtime/world/world-runtime-item-ground.service.js`
- `WorldRuntimeService` 的 `dispatchDropItem()` / `dispatchTakeGround()` / `dispatchTakeGroundAll()` 已退为 facade，地面与容器物品的丢弃/拾取链路由 `WorldRuntimeItemGroundService` 承接；与 `WorldRuntimeLootContainerService` 的协作边界保持清晰
- 这次不迁移 `dispatchEquipItem()` / `dispatchUnequipItem()` 或 market/NPC 商店链路，只移动 item-ground 这一组叶子业务域，`WorldRuntimeService` 仍保留其他物品/装备命令入口的总编排
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-item-ground`、`pnpm --filter @mud/server smoke:loot`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:redeem-code`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过，其中 `smoke:redeem-code` 在无库口径下返回 `ok: true` 且标记 `skipped`
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-equipment`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-cultivation`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-progression`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-enhancement`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-alchemy`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:runtime`、`pnpm --filter @mud/server smoke:player-respawn`、`pnpm --filter @mud/server smoke:gm-next`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过，其中 `gm-next` 在无库本地口径下返回 `ok: true` 且标记 `skipped`
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:player-respawn` 与 `pnpm --filter @mud/server build`；结果继续通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:monster-runtime`、`pnpm --filter @mud/server smoke:monster-loot`、根级 `pnpm build` 与 `pnpm verify:replace-ready`；结果继续通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-npc-shop`、`pnpm --filter @mud/server smoke:runtime`、根级串行 `pnpm build && pnpm verify:replace-ready`；结果全部通过
...
- 新增 `packages/server/src/tools/world-runtime-npc-quest-write-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-npc-quest-write`，把 NPC quest 写侧 smoke 收成独立证明链
- 这次不迁移 quest query/read、gateway NPC handler 或更宽的 NPC 域重构，只继续把 NPC quest 写侧最小剩余编排收进 `WorldRuntimeNpcQuestWriteService`
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-npc-quest-write`、`pnpm --filter @mud/server smoke:progression` 与根级 `pnpm build`；结果通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-npc-quest-write` 与根级 `pnpm build`；结果通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-enhancement` 与根级 `pnpm build`；结果通过
...
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-alchemy`；结果通过。根级 `pnpm build` 当前被独立的 client/shared 类型导出问题阻塞（`packages/client/src/gm.ts` 等文件报 shared 导出缺失），现象与本轮 server runtime alchemy 切口不直接对应，需单独处理
...
- 新增 `packages/server/src/tools/world-runtime-transfer-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-transfer`，把 transfer 写路径的 no-op / 正常应用 proof 收成 focused smoke
...
- 新增 `packages/server/src/tools/world-runtime-npc-access-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-npc-access`，把 NPC access 的成功 / 透传异常 / 超距拒绝 proof 收成 focused smoke
...
- 新增 `packages/server/src/tools/world-runtime-npc-quest-interaction-query-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-npc-quest-interaction-query`，把 ready / active / available / 空玩家 / 空 NPC 的 marker proof 固定在 focused smoke 内
...
- 新增 `packages/server/src/tools/world-runtime-pending-command-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-pending-command`，把 queue ownership 的 overwrite / clear / dispatch 路由 proof 固定到 focused smoke；既有 `world-runtime-npc-shop-smoke.js`、`world-runtime-npc-quest-write-smoke.js` 也已同步切到新的 queue API
- 本轮验证已补跑 `pnpm --filter @mud/server compile && node dist/tools/world-runtime-pending-command-smoke.js && node dist/tools/world-runtime-npc-shop-smoke.js && node dist/tools/world-runtime-npc-quest-write-smoke.js && node dist/tools/world-runtime-instance-tick-orchestration-smoke.js` 与根级 `pnpm verify:replace-ready`；结果通过，说明 pending queue ownership 收口未打破 queue dispatch、NPC shop / quest 入队链与 local replace-ready 证明链
...
- 新增 `packages/server/src/tools/world-runtime-player-location-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-player-location`，把 location ownership 的 get/set/clear/count/list 路由 proof 固定到 focused smoke；既有 `world-runtime-transfer-smoke.js`、`world-runtime-npc-access-smoke.js`、`world-runtime-movement-smoke.js` 与 `world-runtime-instance-tick-orchestration-smoke.js` 也已同步切到新的 location API
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-player-location`、`pnpm --filter @mud/server smoke:world-runtime-transfer`、`pnpm --filter @mud/server smoke:world-runtime-npc-access`、`pnpm --filter @mud/server smoke:world-runtime-movement`、`pnpm --filter @mud/server smoke:world-runtime-instance-tick-orchestration`、`pnpm --filter @mud/server smoke:runtime`、`pnpm --filter @mud/server smoke:gm-next` 与根级串行 `pnpm build && pnpm verify:replace-ready`；结果通过，说明 player-location ownership 收口未打破传送 / 复生 / 视图 / GM 链路与 local replace-ready 证明链
...
- 新增 `packages/server/src/tools/world-runtime-instance-state-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-instance-state`，把 instance ownership 的 get/set/list/count/reset proof 固定到 focused smoke；既有 `world-runtime-transfer-smoke.js`、`world-runtime-npc-access-smoke.js`、`world-runtime-movement-smoke.js` 与 `world-runtime-instance-tick-orchestration-smoke.js` 也已同步切到新的 instance accessor shape
- 本轮验证已补跑 `pnpm --filter @mud/server smoke:world-runtime-instance-state`、`pnpm --filter @mud/server smoke:world-runtime-transfer`、`pnpm --filter @mud/server smoke:world-runtime-npc-access`、`pnpm --filter @mud/server smoke:world-runtime-movement`、`pnpm --filter @mud/server smoke:world-runtime-instance-tick-orchestration`、`pnpm --filter @mud/server smoke:runtime`、`pnpm --filter @mud/server smoke:gm-next` 与 `pnpm --filter @mud/server build`；结果通过，说明 instance ownership 收口未打破实例查询 / 传送 / 复生 / NPC access / tick orchestration / GM 链路与 server 本地构建证明链
...
- 新增 `packages/server/src/tools/world-runtime-action-execution-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-action-execution`，把 portal / breakthrough / body-training / toggle / NPC shop / NPC quest 动作入口的 proof 固定到 focused smoke
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-action-execution` 与 `pnpm --filter @mud/server smoke:runtime`；结果通过，说明动作入口编排抽离未打破 runtime 主链
...
- 新增 `packages/server/src/tools/world-runtime-combat-command-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-combat-command`，把 basic-attack / cast-skill / legacy target / engage-battle 六个命令入口的委托 proof 固定到 focused smoke
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-combat-command`、`pnpm --filter @mud/server smoke:combat` 与 `pnpm --filter @mud/server smoke:monster-combat`；结果通过，说明 combat command orchestration 抽离未打破玩家/妖兽战斗主链
...
- 新增 `packages/server/src/tools/world-runtime-player-command-enqueue-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-player-command-enqueue`，把 basic-attack 目标归一化、alchemy/enhancement payload clone、cast-skill 校验与 heaven-gate action 入队 proof 固定到 focused smoke
...
- 新增 `packages/server/src/tools/world-runtime-system-command-enqueue-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-system-command-enqueue`，把 monster-loot / damage-player 入队归一化与 GM enqueue delegations 固定到 focused smoke
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-player-command-enqueue`、`pnpm --filter @mud/server smoke:world-runtime-system-command-enqueue` 与 `node dist/tools/smoke-suite.js --case runtime --case combat --case player-respawn`；结果通过，说明 player/system enqueue orchestration 抽离未打破 runtime / combat / respawn 主链
...
- 新增 `packages/server/src/tools/world-runtime-player-command-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-player-command`，把 dead-player gating、cast-skill 路由与 NPC quest 路由 proof 固定到 focused smoke
...
- 新增 `packages/server/src/tools/world-runtime-player-combat-outcome-smoke.js` 与 `pnpm --filter @mud/server smoke:world-runtime-player-combat-outcome`，把 damage / kill / defeat / pending-respawn / respawn delegation proof 固定到 focused smoke
- 本轮验证已补跑 `pnpm --filter @mud/server compile`、`pnpm --filter @mud/server smoke:world-runtime-player-command`、`pnpm --filter @mud/server smoke:world-runtime-player-command-enqueue`、`pnpm --filter @mud/server smoke:world-runtime-player-combat-outcome` 与 `node dist/tools/smoke-suite.js --case runtime --case combat --case player-respawn`；结果通过，说明 player command dispatch + outcome/respawn seam 抽离未打破 runtime / combat / respawn 主链
...
- `proof:mainline-boundaries` 现已接入 `@mud/server verify / verify:with-db / verify:replace-ready / verify:proof:with-db / verify:replace-ready:with-db`
- 这条 proof 默认检查：
...
- `pnpm --filter @mud/server smoke:loot`
- `pnpm --filter @mud/server smoke:monster-runtime`
- `pnpm --filter @mud/server smoke:monster-combat`
- `pnpm --filter @mud/server smoke:monster-loot`
- `pnpm --filter @mud/server smoke:player-respawn`
- `pnpm --filter @mud/server smoke:world-runtime-npc-access`
- `pnpm --filter @mud/server smoke:world-runtime-npc-quest-interaction-query`
- `pnpm --filter @mud/server smoke:world-runtime-npc-shop`
- `pnpm --filter @mud/server smoke:world-runtime-npc-quest-write`
