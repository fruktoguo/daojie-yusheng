...
/** isCompactViewport：判断并返回条件结果。 */
  private isCompactViewport(): boolean {
    return window.innerWidth <= 900;
  }

/** syncResponsiveModalChrome：同步外部状态到本地。 */
...
/** syncModalDisplaySwitch：同步外部状态到本地。 */
