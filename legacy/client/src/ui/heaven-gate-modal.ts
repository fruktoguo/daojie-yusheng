...
/** clearPendingAction：清理并清空临时数据。 */
function clearPendingAction(): void {
  pendingAction = null;
}

/** renderHeavenGateModal：渲染当前界面内容。 */
...
/** refreshHeavenGateModal：刷新缓存并触发重绘。 */
