...
/** parseConfirmQuantity：解析参数并返回标准化结果。 */
...
/** syncStartConfirmState：同步外部状态到本地。 */
...
/** syncStartConfirmModal：同步外部状态到本地。 */
