...
/** formatBonusSummary：格式化输出字符串用于展示。 */
...
/** refreshInfusionModal：刷新缓存并触发重绘。 */
...
/** renderInfusionModalBody：渲染当前界面内容。 */
...
/** isInfusionButtonDisabled：判断并返回条件结果。 */
