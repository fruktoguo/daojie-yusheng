...
/** formatMoveSpeedDisplay：格式化输出字符串用于展示。 */
...
/** formatSignedBreakdownValue：格式化输出字符串用于展示。 */
...
/** renderTooltipPrimaryLine：渲染当前界面内容。 */
...
/** renderTooltipSectionLine：渲染当前界面内容。 */
...
/** renderTooltipChildLine：渲染当前界面内容。 */
