...
/** syncPurchaseConfirmModal：同步外部状态到本地。 */
...
/** formatRefreshHint：格式化输出字符串用于展示。 */
...
/** findInventoryItemCount：从集合中查找目标。 */
