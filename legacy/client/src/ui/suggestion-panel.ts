...
/** setupGlobalListeners：设置并同步相关状态。 */
...
/** requestSuggestionsIfNeeded：发起对应请求。 */
...
/** renderSuggestionListEntry：渲染当前界面内容。 */
...
/** renderSuggestionDetail：渲染当前界面内容。 */
