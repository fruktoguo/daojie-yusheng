...
/** parseBuffFormulaVar：解析参数并返回标准化结果。 */
...
/** renderVariableFormula：渲染当前界面内容。 */
...
/** isPercentFactorFormula：判断并返回条件结果。 */
...
/** formatDamageFormula：格式化输出字符串用于展示。 */
