...
var NextGmAdminService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.NextGmAdminService = void 0;
...
const DATABASE_BACKUP_METADATA_SCOPES = [DATABASE_BACKUP_METADATA_SCOPE, LEGACY_DATABASE_BACKUP_METADATA_SCOPE];

const DATABASE_JOB_STATE_SCOPES = [DATABASE_JOB_STATE_SCOPE, LEGACY_DATABASE_JOB_STATE_SCOPE];
...
const BACKUP_EXCLUDED_SCOPES = new Set([
    ...
    LEGACY_DATABASE_BACKUP_METADATA_SCOPE,
    DATABASE_JOB_STATE_SCOPE,
    LEGACY_DATABASE_JOB_STATE_SCOPE,
]);
...
let NextGmAdminService = NextGmAdminService_1 = class NextGmAdminService {
    logger = new common_1.Logger(NextGmAdminService_1.name);
    pool = null;
...
exports.NextGmAdminService = NextGmAdminService;
exports.NextGmAdminService = NextGmAdminService = NextGmAdminService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [next_database_restore_coordinator_service_1.NextDatabaseRestoreCoordinatorService])
], NextGmAdminService);
