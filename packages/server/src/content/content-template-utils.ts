...
function normalizeConsumableBuffs(raw) {
    ...
    const buffs = raw.flatMap((entry) => {
        ...
        return [{
                ...
                immuneToCleanse: candidate.immuneToCleanse === true ? true : undefined,
...
function normalizeSkillPassiveEffect(raw, skillId, skillName, index) {
    ...
    if (raw.type === 'buff') {
        ...
        const effect = {
            ...
            immuneToCleanse: raw.immuneToCleanse === true ? true : undefined,
        };
        return compactPassiveEffect(effect);
    }
