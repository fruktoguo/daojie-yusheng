...
import {
  HEAVEN_GATE_MAX_SEVERED,
  HEAVEN_GATE_REROLL_AVERAGE_BONUS,
  resolveStageForRealmLevel,
  resolveRealmLevelFromStage,
  createEmptyMutation,
  describeProgressionDirtyDomains,
  toProgressionMutationResult,
  mergeProgressionMutation,
  snapshotTechniqueProgressionInput,
  hasSameTechniqueProgressionInputs,
  beginMonsterKillProgressPerf,
  recordMonsterKillProgressPerf,
  recordMonsterKillProgressCount,
  applyRateBonus,
  applyTechniqueRateBonus,
  applyTransmissionSkillExpFromTicks,
  normalizeCultivationAuraMultiplier,
  capSingleCombatRealmExpGain,
  calculateOverflowFoundationGain,
  getMonsterKillRealmExpAdjustment,
  snapshotCultivatingTechnique,
  resolveSingleTechniqueProgressStatisticChangedIds,
  snapshotCultivatingTechniqueStatisticState,
  toTechniqueUpdateEntryLocal,
  calculateRealmProgressGain,
  calculateTechniqueGain,
  formatProgressionGainAmount,
  createEmptyRoots,
  createSpiritualRootSeedRoots,
  getHeavenGateRerollCount,
  getHeavenGateAverageBonusFromRerollCount,
  normalizeHeavenGateState,
} from './player-progression.helpers';
