...
import { ALCHEMY_CATALOG_VERSION, cloneAlchemyCatalogEntry, cloneAlchemyJob, cloneAlchemyPreset } from './craft-panel-alchemy-query.helpers';
 ...
 */
  ...
  // 关键分支按状态与边界条件处理，非法路径会被提前拦截。
        ...
        const furnaceItemId = equippedTool?.itemId;
        return {
            furnaceItemId,
            toolStats,
