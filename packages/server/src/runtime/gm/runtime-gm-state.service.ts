...
const CPU_BREAKDOWN_LABELS = Object.freeze({
    ...
    'tick.autoCombat.viewMs': '自动战斗·视野构造',
    'tick.autoCombat.threatRefreshMs': '自动战斗·仇恨刷新',
    'tick.autoCombat.targetSelectMs': '自动战斗·目标选择',
    'tick.autoCombat.retargetOverrideMs': '自动战斗·反击目标',
    'tick.autoCombat.trackedTargetMs': '自动战斗·锁定目标',
    'tick.autoCombat.threatEntriesMs': '自动战斗·仇恨读取',
    'tick.autoCombat.candidateBuildMs': '自动战斗·候选构造',
    'tick.autoCombat.candidateScoreMs': '自动战斗·候选评分',
    'tick.autoCombat.setTargetMs': '自动战斗·目标写入',
    'tick.autoCombat.skillChoiceMs': '自动战斗·技能选择',
    'tick.autoCombat.losCheckMs': '自动战斗·视线检查',
    'tick.autoCombat.losPathMs': '自动战斗·视线寻路',
    'tick.autoCombat.pathMs': '自动战斗·追击寻路',
    'worker.instancePrecomputeMs': 'Worker·实例预计算',
    'instance.stepCommandMaterializationMs': '实例·加速步命令物化',
    'attribution.instance.timeChamber.firstStepMs': '归因·密室帧首个逻辑步',
    'attribution.instance.timeChamber.extraStepMs': '归因·密室额外逻辑步',
    'attribution.instance.timeChamber.extraStepMaterializationMs': '归因·密室额外步命令物化',
    'attribution.instance.timeChamber.playerSteps': '归因·密室玩家逻辑步数',
    'attribution.instance.nonTimeChamber.firstStepMs': '归因·非密室帧首个逻辑步',
    ...
    'monsterActions.chantPlanMs': '怪物动作·吟唱规划',
    'monsterActions.chantPresentationMs': '怪物动作·吟唱表现',
    'monsterActions.basicTargetPlanMs': '怪物动作·普攻目标',
    'monsterActions.basicCombatResolveMs': '怪物动作·普攻公式',
    'monsterActions.basicOutcomeApplyMs': '怪物动作·普攻落地',
    'monsterActions.basicPresentationMs': '怪物动作·普攻表现',
    'monsterActions.skillPlanMs': '怪物动作·技能规划',
    'monsterActions.skillTargetApplyMs': '怪物动作·技能目标复核',
    'monsterActions.skillCombatResolveMs': '怪物动作·技能公式',
    'monsterActions.skill.formulaEvalMs': '怪物技能·公式求值',
    'monsterActions.skill.damagePipelineMs': '怪物技能·伤害管线',
    'monsterActions.skill.buffBuildMs': '怪物技能·Buff 构造',
    'monsterActions.skill.buffApplySelfMs': '怪物技能·自身 Buff 应用',
    'monsterActions.skill.buffApplyTargetMs': '怪物技能·目标 Buff 应用',
    'monsterActions.skill.healApplyMs': '怪物技能·治疗应用',
    'monsterActions.skillOutcomeApplyMs': '怪物动作·技能落地',
    'monsterActions.skillThreatMs': '怪物动作·仇恨写入',
    'monsterActions.skillPresentationMs': '怪物动作·技能表现',
    ...
    'instance.craftJob.compatibilityMs': '技艺推进·恢复兼容检查',
    'instance.craftJob.activeKindPlanMs': '技艺推进·活跃任务规划',
    'instance.craftJob.alchemyMs': '技艺推进·炼丹',
    'instance.craftJob.forgingMs': '技艺推进·炼器',
    'instance.craftJob.enhancementMs': '技艺推进·强化',
    'instance.craftJob.transmissionMs': '技艺推进·传功',
    'instance.craftJob.gatherMs': '技艺推进·采集',
    'instance.craftJob.miningMs': '技艺推进·采矿',
    'instance.craftJob.buildingMs': '技艺推进·建造',
    'instance.craftJob.formationMs': '技艺推进·阵法',
    'instance.craftJob.otherMs': '技艺推进·其他任务',
    'instance.craftJob.syncAdvanceMs': '技艺推进·同步普通路径',
    'instance.craftJob.asyncBoundaryMs': '技艺推进·异步资产边界',
    'instance.craftJob.progressOnlyMs': '技艺推进·仅进度变更',
    'instance.craftJob.assetMutationMs': '技艺推进·资产变更',
    'instance.craftJob.mutationFlushMs': '技艺推进·结果刷新',
    'instance.craftJob.queueAdvanceMs': '技艺推进·队列启动',
    'instance.craftJob.enhancementAsyncStateGuard': '强化异步边界·状态保护次数',
    'instance.craftJob.enhancementAsyncQueueBusy': '强化异步边界·资产队列繁忙次数',
    'instance.craftJob.enhancementAsyncSettlement': '强化异步边界·结算次数',
    'instance.craftJob.enhancementAsyncUnsupported': '强化异步边界·缺少同步能力次数',
    'instance.craftJob.enhancementAssetQueueWaitMs': '强化异步边界·资产队列等待',
    'instance.craftJob.enhancementRuntimeResolveMs': '强化异步边界·运行态结算',
    'instance.craftJob.enhancementPresenceFenceMs': '强化异步边界·所有权围栏',
    'instance.craftJob.enhancementPresenceDescribeMs': '强化所有权围栏·运行态描述',
    'instance.craftJob.enhancementPresenceClaimMs': '强化所有权围栏·运行态认领',
    'instance.craftJob.enhancementPresenceDirty': '强化所有权围栏·presence 脏状态次数',
    'instance.craftJob.enhancementPresenceClean': '强化所有权围栏·presence 净状态次数',
    'instance.craftJob.enhancementPresencePersistMs': '强化所有权围栏·presence 持久化',
    ...
    'instance.fengShuiFinalizeMs': '实例·低频风水收敛',
    'instance.fengShuiFinalizeTopologyMs': '风水收敛·拓扑全量重算',
    'instance.fengShuiFinalizeLocalMs': '风水收敛·局部房间重算',
    'instance.fengShuiFinalizeFailures': '风水收敛·失败重试次数',
    'instance.fengShuiFinalizeRequests': '风水收敛·标脏请求数',
    'instance.fengShuiFinalizeCoalescedRequests': '风水收敛·合并请求数',
    'instance.fengShuiFinalizeDirtyCells': '风水收敛·脏地块数',
    'instance.fengShuiFinalizeRooms': '风水收敛·重算房间数',
    'instance.fengShuiFinalizeCadenceDeferrals': '风水收敛·降频延后批次',
    ...
    'playerTick.comprehensionProjectionMs': '玩家 tick·领悟速度投影',
    'playerTick.comprehensionProjectionDeferrals': '领悟速度投影·批次内延后次数',
    'playerTick.comprehensionProjectionCacheHits': '领悟速度投影·缓存命中次数',
    'playerTick.comprehensionProjectionRecalculations': '领悟速度投影·实际重算次数',
    ...
    'playerTick.offlineGainProgressionProfessionDeltaMs': '收益累计·进度职业联合差量',
    ...
    'playerTick.offlineGainOnlineTotalsMs': '收益累计·在线总账',
    ...
    'pendingCommands.castSkill.targetPlanMs': '技能施放·目标规划',
    'pendingCommands.castSkill.targetPlan.definitionMs': '目标规划·动作定义（抽样估算）',
    'pendingCommands.castSkill.targetPlan.collectionMs': '目标规划·目标收集（抽样估算）',
    'pendingCommands.castSkill.targetPlan.cellGeometryMs': '目标规划·受影响格计算（抽样估算）',
    'pendingCommands.castSkill.targetPlan.cellLookupMs': '目标规划·格内实体查询（抽样估算）',
    'pendingCommands.castSkill.targetPlan.affectedCells': '目标规划·受影响格数（抽样估算）',
    'pendingCommands.castSkill.targetPlan.validationMs': '目标规划·目标验证（抽样估算）',
    'pendingCommands.castSkill.targetPlan.resourceCooldownMs': '目标规划·资源冷却校验（抽样估算）',
    'pendingCommands.castSkill.targetApplyMs': '技能施放·目标结算',
    'pendingCommands.castSkill.combatResolveMs': '目标结算·战斗公式',
    'pendingCommands.castSkill.formulaEvalMs': '技能施放·公式求值',
    'pendingCommands.castSkill.damagePipelineMs': '技能施放·伤害管线',
    'pendingCommands.castSkill.buffBuildMs': '技能施放·Buff 构造',
    'pendingCommands.castSkill.buffApplySelfMs': '技能施放·自身 Buff 应用',
    'pendingCommands.castSkill.buffApplyTargetMs': '技能施放·目标 Buff 应用',
    'pendingCommands.castSkill.healApplyMs': '技能施放·治疗应用',
    'combat.outcome.createNormalizeMs': '战斗结果·创建/规范化',
    'combat.outcome.adapterMs': '战斗结果·适配器副作用',
    'combat.outcome.mergeMs': '战斗结果·适配结果合并',
    'combat.outcome.recordMs': '战斗结果·事件记录',
    'pendingCommands.castSkill.outcomeApplyMs': '目标结算·结果落地',
    'pendingCommands.castSkill.outcomeApply.selfMs': '目标结算·自身结果',
    'pendingCommands.castSkill.outcomeApply.monsterMs': '目标结算·妖兽结果',
    'pendingCommands.castSkill.outcomeApply.playerMs': '目标结算·玩家结果',
    'pendingCommands.castSkill.outcomeApply.formationMs': '目标结算·阵法结果',
    'pendingCommands.castSkill.outcomeApply.formationBoundaryMs': '目标结算·阵法边界结果',
    'pendingCommands.castSkill.outcomeApply.tileMs': '目标结算·单地块结果',
    'pendingCommands.castSkill.outcomeApply.tileBatchMs': '目标结算·批量地块结果',
    'pendingCommands.castSkill.tileBatch.damageApplyMs': '批量地块·权威伤害写入',
    'pendingCommands.castSkill.tileBatch.damageApply.entryResolveMs': '权威伤害写入·输入解析/守卫',
    'pendingCommands.castSkill.tileBatch.damageApply.fallbackMs': '权威伤害写入·特殊地块回退',
    'pendingCommands.castSkill.tileBatch.damageApply.dropRollMs': '权威伤害写入·地块掉落掷骰',
    'pendingCommands.castSkill.tileBatch.damageApply.mutationMs': '权威伤害写入·地块状态变更',
    'pendingCommands.castSkill.tileBatch.damageApply.stateWriteMs': '地块状态变更·损坏状态写入',
    'pendingCommands.castSkill.tileBatch.damageApply.staticSyncMs': '地块状态变更·静态同步/AOI 失效',
    'pendingCommands.castSkill.tileBatch.damageApply.finalizeMs': '权威伤害写入·批量脏域提交',
    'pendingCommands.castSkill.tileBatch.damageApply.fastPathEntries': '权威伤害写入·普通地块数',
    'pendingCommands.castSkill.tileBatch.damageApply.fallbackEntries': '权威伤害写入·回退地块数',
    'pendingCommands.castSkill.tileBatch.damageApply.fallbackVirtualBoundaryEntries': '回退地块·虚拟边界数',
    'pendingCommands.castSkill.tileBatch.damageApply.fallbackTemporaryEntries': '回退地块·临时地块数',
    'pendingCommands.castSkill.tileBatch.damageApply.fallbackBuildingEntries': '回退地块·建筑数',
    'pendingCommands.castSkill.tileBatch.damageApply.fallbackInvalidTileEntries': '回退地块·无效索引数',
    'pendingCommands.castSkill.tileBatch.damageApply.fallbackSectBoundaryEntries': '回退地块·宗门扩展边界数',
    'pendingCommands.castSkill.tileBatch.damageApply.fallbackRoomTopologyEntries': '回退地块·房间拓扑数',
    'pendingCommands.castSkill.tileBatch.damageApply.fallbackRoomIntegrityEntries': '回退地块·房间完整度数',
    'pendingCommands.castSkill.tileBatch.damageApply.destroyedEntries': '权威伤害写入·摧毁地块数',
    'pendingCommands.castSkill.tileBatch.damageApply.dirtyEntries': '权威伤害写入·持久化脏地块数',
    'pendingCommands.castSkill.tileBatch.resultCollectMs': '批量地块·结果汇总',
    'pendingCommands.castSkill.tileBatch.dropSpawnMs': '批量地块·掉落生成',
    ...
    'pendingCommands.castSkill.monsterRuntimeRefCalls': '目标结算·妖兽运行态引用读取次数',
    'pendingCommands.castSkill.monsterSnapshotFallbackCalls': '目标结算·妖兽快照回退读取次数',
    ...
    'combat.playerMonsterKill.progressApplyMs': '击杀奖励·参与者进度应用',
    'combat.playerMonsterKill.progressSnapshotMs': '击杀奖励·进度前快照',
    'combat.playerMonsterKill.progressResolveMs': '击杀奖励·进度算法',
    'combat.playerMonsterKill.progressGainPlanMs': '击杀奖励·经验收益规划',
    'combat.playerMonsterKill.progressRealmAdvanceMs': '击杀奖励·境界推进',
    ...
    'combat.playerMonsterKill.dropRollMs': '击杀奖励·掉落掷骰',
    'combat.playerMonsterKill.lootDeliveryMs': '击杀奖励·掉落交付',
    'combat.playerMonsterKill.lootItems': '击杀奖励·掉落物品数',
    'combat.playerMonsterKill.lootReceiptMs': '掉落交付·容量校验/背包写入',
    'combat.playerMonsterKill.lootCapacityCheckMs': '掉落交付·背包容量检查',
    'combat.playerMonsterKill.lootInventoryApplyMs': '掉落交付·背包写入',
    'combat.playerMonsterKill.lootGroundSpawnMs': '掉落交付·满包落地',
    'combat.playerMonsterKill.lootNoticeMs': '掉落交付·通知构建/入队',
    'pendingCommands.castSkill.presentationMs': '目标结算·表现推送',
    'pendingCommands.castSkill.postEffectsMs': '技能施放·后处理',
    'attribution.skill.autoCommandMs': '归因·自动战斗技能命令',
    'attribution.skill.manualCommandMs': '归因·手动技能命令',
    'attribution.skill.timeChamber.resolveMs': '归因·密室技能实际结算',
    'attribution.skill.nonTimeChamber.resolveMs': '归因·非密室技能实际结算',
    'attribution.skill.timeChamber.monsterDefeats': '归因·密室技能击杀妖兽数',
    'attribution.skill.nonTimeChamber.monsterDefeats': '归因·非密室技能击杀妖兽数',
    'attribution.skill.resolve.targets1Ms': '归因·技能单目标结算',
    'attribution.skill.resolve.targets2To5Ms': '归因·技能 2-5 目标结算',
    'attribution.skill.resolve.targets6To20Ms': '归因·技能 6-20 目标结算',
    'attribution.skill.resolve.targets21PlusMs': '归因·技能 21+ 目标结算',
    'attribution.skill.targets': '归因·技能实际目标数',
    'attribution.attributes.recalculateMs': '归因·属性完整重算',
    'attribution.attributes.recalculate.changed': '归因·属性重算有变化次数',
    'attribution.attributes.recalculate.unchanged': '归因·属性重算无变化次数',
    'attribution.attributes.deferredRequests': '归因·属性标脏请求数',
    'attribution.attributes.coalescedRequests': '归因·属性脏请求合并数',
    'attribution.attributes.batchFlushes': '归因·属性区间末刷新数',
    'attribution.attributes.ensureFreshFlushes': '归因·属性权威读取刷新数',
    'attribution.attributes.request.worldTime': '属性请求·世界时间视野',
    'attribution.attributes.request.fengShuiLuck': '属性请求·风水幸运',
    'attribution.attributes.request.realmProgression': '属性请求·境界推进',
    'attribution.attributes.request.techniqueProgression': '属性请求·功法推进',
    'attribution.attributes.request.bodyTraining': '属性请求·炼体推进',
    'attribution.attributes.request.buff': '属性请求·Buff 变化',
    'attribution.attributes.request.cultivationState': '属性请求·修炼状态',
    'attribution.attributes.request.initialization': '属性请求·运行态初始化',
    'attribution.attributes.request.leaderboardProjection': '属性请求·排行榜投影',
    'attribution.attributes.request.equipment': '属性请求·装备变化',
    'attribution.attributes.request.techniqueMutation': '属性请求·功法增删',
    'attribution.attributes.request.fortune': '属性请求·运势变化',
    'attribution.attributes.request.respawn': '属性请求·复活收敛',
    'attribution.attributes.request.craftSettlement': '属性请求·技艺结算',
    'attribution.attributes.request.other': '属性请求·其他低频入口',
    ...
    'attribution.attributes.build.sourceSetupMs': '属性重算·基础源准备',
    'attribution.attributes.build.baseAttributesMs': '属性重算·基础六维合成',
    'attribution.attributes.build.equipmentProjectionMs': '属性重算·装备投影',
    'attribution.attributes.equipmentResolve.cacheHitMs': '属性重算·装备转换缓存命中',
    'attribution.attributes.equipmentResolve.cacheMissMs': '属性重算·装备转换缓存未命中',
    'attribution.attributes.build.buffAttributeProjectionMs': '属性重算·Buff 六维投影',
    'attribution.attributes.build.attributeWeightsMs': '属性重算·六维数值换算',
    'attribution.attributes.build.equipmentStatsMs': '属性重算·装备数值效果',
    'attribution.attributes.build.buffStatsMs': '属性重算·Buff 数值效果',
    'attribution.attributes.build.finalModifiersMs': '属性重算·最终倍率与取整',
    'attribution.attributes.build.equipmentEntries': '属性重算·扫描装备槽数',
    'attribution.attributes.build.buffEntries': '属性重算·扫描 Buff 数',
    'attribution.attributes.recalculate.techniques0Ms': '归因·属性重算（0 本功法）',
    'attribution.attributes.recalculate.techniques1To5Ms': '归因·属性重算（1-5 本功法）',
    'attribution.attributes.recalculate.techniques6To10Ms': '归因·属性重算（6-10 本功法）',
    'attribution.attributes.recalculate.techniques11To20Ms': '归因·属性重算（11-20 本功法）',
    'attribution.attributes.recalculate.techniques21PlusMs': '归因·属性重算（21+ 本功法）',
    ...
    'syncFlush.envelopeContainerProjectionMs': '同步·主包容器投影',
    'syncFlush.envelopeProjectorMs': '同步·主包世界/面板投影',
    'syncFlush.envelopeEventBusMs': '同步·主包 EventBus 附加',
    'syncFlush.projectorIdentityMs': '同步·投影账号身份',
    'syncFlush.projectorWorldMs': '同步·投影世界差量',
    'syncFlush.projectorSelfMs': '同步·投影自身差量',
    'syncFlush.projectorPanelMs': '同步·投影面板差量',
    'syncFlush.projectorPanelAttrCheckMs': '同步·面板属性变化判定',
    'syncFlush.projectorPanelBuffProjectionMs': '同步·面板 Buff 投影',
    'syncFlush.projectorPanelCursorMs': '同步·面板游标构造',
    'syncFlush.projectorPanelAttrSliceMs': '同步·面板属性切片',
    'syncFlush.projectorPanelActionSliceMs': '同步·面板动作切片',
    'syncFlush.projectorPanelDeltaMs': '同步·面板基础差量',
    'syncFlush.projectorPanelTechniqueMs': '同步·面板功法差量',
    'syncFlush.projectorCacheMs': '同步·投影缓存提交',
    ...
    'syncFlush.projector.fullRebuild': '同步·投影全量重建',
    'syncFlush.projector.worldReuse': '同步·投影世界缓存命中',
    'syncFlush.projector.worldCapture': '同步·投影世界重新捕获',
    'syncFlush.projector.panel.attrNone': '同步·面板属性无变化',
    'syncFlush.projector.panel.attrRealmProgress': '同步·面板仅修为进度变化',
    'syncFlush.projector.panel.attrFull': '同步·面板属性完整变化',
    'syncFlush.projector.panel.actionReuse': '同步·面板动作缓存命中',
    'syncFlush.projector.panel.inventoryDelta': '同步·面板背包差量',
    'syncFlush.projector.panel.equipmentDelta': '同步·面板装备差量',
    'syncFlush.projector.panel.artifactDelta': '同步·面板法宝差量',
    'syncFlush.projector.panel.techniqueDelta': '同步·面板功法差量包',
    'syncFlush.projector.panel.attrDelta': '同步·面板属性差量包',
    'syncFlush.projector.panel.actionDelta': '同步·面板动作差量包',
    'syncFlush.projector.panel.buffDelta': '同步·面板 Buff 差量包',
    'syncFlush.projector.panel.techniqueEntries': '同步·面板功法扫描条目',
    'syncFlush.projector.panel.actionEntries': '同步·面板动作扫描条目',
    'syncFlush.projector.panel.buffEntries': '同步·面板 Buff 投影条目',
    ...
    'syncFlush.aux.mapDirtyTiles': '同步·辅助地图原始脏地块数',
    'syncFlush.aux.mapVisibleDirtyTiles': '同步·辅助地图可见脏地块数',
    'syncFlush.aux.mapTilePatchEntries': '同步·辅助地图实际地块 patch 数',
    'syncFlush.aux.mapDirtyProjectionNoop': '同步·辅助地图投影后无变化',
...
const SYNC_FLUSH_BREAKDOWN_DEFS = Object.freeze([
    ...
    { key: 'envelopeContainerProjectionMs', countKey: 'envelopeContainerProjectionCount' },
    { key: 'envelopeProjectorMs', countKey: 'envelopeProjectorCount' },
    { key: 'envelopeEventBusMs', countKey: 'envelopeEventBusCount' },
    { key: 'projectorIdentityMs', countKey: 'projectorIdentityCount' },
    { key: 'projectorWorldMs', countKey: 'projectorWorldCount' },
    { key: 'projectorSelfMs', countKey: 'projectorSelfCount' },
    { key: 'projectorPanelMs', countKey: 'projectorPanelCount' },
    { key: 'projectorPanelAttrCheckMs', countKey: 'projectorPanelAttrCheckCount' },
    { key: 'projectorPanelBuffProjectionMs', countKey: 'projectorPanelBuffProjectionCount' },
    { key: 'projectorPanelCursorMs', countKey: 'projectorPanelCursorCount' },
    { key: 'projectorPanelAttrSliceMs', countKey: 'projectorPanelAttrSliceCount' },
    { key: 'projectorPanelActionSliceMs', countKey: 'projectorPanelActionSliceCount' },
    { key: 'projectorPanelDeltaMs', countKey: 'projectorPanelDeltaCount' },
    { key: 'projectorPanelTechniqueMs', countKey: 'projectorPanelTechniqueCount' },
    { key: 'projectorCacheMs', countKey: 'projectorCacheCount' },
...
const SYNC_FLUSH_DETAIL_COUNT_DEFS = Object.freeze([
    ...
    { key: 'projector.fullRebuild', countKey: 'projectorFullRebuildCount' },
    { key: 'projector.worldReuse', countKey: 'projectorWorldReuseCount' },
    { key: 'projector.worldCapture', countKey: 'projectorWorldCaptureCount' },
    { key: 'projector.panel.attrNone', countKey: 'projectorPanelAttrNoneCount' },
    { key: 'projector.panel.attrRealmProgress', countKey: 'projectorPanelAttrRealmProgressCount' },
    { key: 'projector.panel.attrFull', countKey: 'projectorPanelAttrFullCount' },
    { key: 'projector.panel.actionReuse', countKey: 'projectorPanelActionReuseCount' },
    { key: 'projector.panel.inventoryDelta', countKey: 'projectorPanelInventoryDeltaCount' },
    { key: 'projector.panel.equipmentDelta', countKey: 'projectorPanelEquipmentDeltaCount' },
    { key: 'projector.panel.artifactDelta', countKey: 'projectorPanelArtifactDeltaCount' },
    { key: 'projector.panel.techniqueDelta', countKey: 'projectorPanelTechniqueDeltaCount' },
    { key: 'projector.panel.attrDelta', countKey: 'projectorPanelAttrDeltaCount' },
    { key: 'projector.panel.actionDelta', countKey: 'projectorPanelActionDeltaCount' },
    { key: 'projector.panel.buffDelta', countKey: 'projectorPanelBuffDeltaCount' },
    { key: 'projector.panel.techniqueEntries', countKey: 'projectorPanelTechniqueEntryCount' },
    { key: 'projector.panel.actionEntries', countKey: 'projectorPanelActionEntryCount' },
    { key: 'projector.panel.buffEntries', countKey: 'projectorPanelBuffEntryCount' },
    ...
    { key: 'aux.mapDirtyTiles', countKey: 'auxMapDirtyTileCount' },
    { key: 'aux.mapVisibleDirtyTiles', countKey: 'auxMapVisibleDirtyTileCount' },
    { key: 'aux.mapTilePatchEntries', countKey: 'auxMapTilePatchEntryCount' },
    { key: 'aux.mapDirtyProjectionNoop', countKey: 'auxMapDirtyProjectionNoopCount' },
