...
const CPU_BREAKDOWN_LABELS = Object.freeze({
    ...
    'instance.fengShuiFinalizeMs': '实例·息末风水收敛',
    'instance.fengShuiFinalizeTopologyMs': '息末风水·拓扑全量重算',
    'instance.fengShuiFinalizeLocalMs': '息末风水·局部房间重算',
    'instance.fengShuiFinalizeFailures': '息末风水·失败重试次数',
    'instance.fengShuiFinalizeRequests': '息末风水·标脏请求数',
    'instance.fengShuiFinalizeCoalescedRequests': '息末风水·合并请求数',
    'instance.fengShuiFinalizeDirtyCells': '息末风水·脏地块数',
    'instance.fengShuiFinalizeRooms': '息末风水·重算房间数',
