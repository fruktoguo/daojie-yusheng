...
import { computeAdjustedCraftTicks, createItemStackSignature, mergeItemStackInto, resolveAlchemyGradeValue } from '@mud/shared';
...
import * as loot_container_helpers from './world-runtime-loot-container.helpers';
...
const {
 buildIsContainerSourceId,
 resolveContainerRefreshAtTick,
 repairStaleHerbSchedule,
 buildContainerMutationResult,
 resolveActiveSearchPlayerId,
 resolveActiveSearchJobRunId,
 resolveGatherJobRunId,
 hasGatherJobRunIdConflict,
 hasGatherItemKeyConflict,
 createGatherJobRunId,
 normalizeGatherJobRemainingTicks,
 isActiveGatherJobForTarget,
 isGatherJobExactSearchMatch,
 collectHydratedInstanceResidentPlayers,
 isInstancePlayerHydrationConfirmed,
 isActiveSearchOwnedByPlayer,
 buildContainerTickResult,
 buildGatherTechniqueNotice,
 normalizeGatherResourceNodeName,
 resolveGatherInterruptReasonLabel,
 cloneContainerState,
 removeSingleContainerRowItem,
 mergeContainerEntries,
 countContainerEntryItems,
 touchRuntimeInstanceRevision,
 getContainerRespawnRemainingTicks,
 buildNextInventorySnapshots,
 buildGrantedInventorySnapshots,
 cloneContainerEntryForRestore,
 cloneContainerStateForRollback,
 restoreContainerStateFromRollbackSnapshot,
 readInstancePersistenceDomainRevision,
 restoreGroundSourceAfterFailedTake,
 captureInventoryGrantRollbackState,
 restoreInventoryGrantRollbackState,
 resolveLootSourceOwnershipEpoch,
 buildGroundSourceFlushLedgerPayload,
 buildContainerSourceFlushLedgerPayload,
 buildLootInventoryGrantOperationId,
 parseGroundLootSourceTileIndex,
 resolveLootInstanceLeaseContext,
} = loot_container_helpers;
...
function computeEffectiveHerbGatherTicks(player, container, row) {
 ...
 return computeAdjustedCraftTicks(
  nativeGatherTicks,
  gatherLevel * GATHER_SPEED_PER_LEVEL + resolvePlayerCraftEffectStat(player, 'gather', 'speedRate'),
 );
}
