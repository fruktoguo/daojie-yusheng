...
import * as formation_helpers from './world-runtime-formation.helpers';

const {
 TERRAIN_STABILIZER_EFFECT_KIND,
 BOUNDARY_BARRIER_EFFECT_KIND,
 INSTANCE_FORMATION_STATE_TABLE,
 FORMATION_LOCK_NAMESPACE,
 INSTANCE_FORMATION_STATE_BIGINT_COLUMNS,
 INSTANCE_FORMATION_STATE_DOUBLE_COLUMNS,
 FORMATION_LIFECYCLE_DEPLOYED,
 FORMATION_LIFECYCLE_PERSISTENT,
 FORMATION_MAINTENANCE_CONTROL_RADIUS,
 FORMATION_QI_DECAY_RATE_SCALED,
 runtimeFormationProjectionCache,
 normalizeBoundedRuntimeInteger,
 normalizeSlotIndex,
 normalizePositiveInteger,
 normalizeNonNegativeInteger,
 normalizeLoadedFormationBudget,
 resolveLoadedRemainingQiBudget,
 resolveFormationPlacement,
 firstFiniteInteger,
 isWithinFormationMaintenanceControlRange,
 normalizeInstanceId,
 normalizeOptionalString,
 resolvePlayerSectId,
 resolveFormationSkillLevel,
 assertCanPlaceFormationInInstance,
 normalizeFormationDiskTier,
 normalizeFormationLifecycle,
 resolveFormationLifecycle,
 isPersistentFormation,
 isActiveTerrainStabilizerFormation,
 isActiveFormationOfKind,
 buildTerrainStabilizationChecker,
 forEachFormationAffectedRuntimeCell,
 assertFormationProtectedPlacementAllowed,
 isFormationProtectedPlacementAllowed,
 isFormationAffectedCell,
 resolveFormationTickCost,
 buildFormationResourceInventoryPlan,
 cloneFormationForResourceMutation,
 captureFormationMaintenanceRuntimeState,
 restoreFormationMaintenanceRuntimeState,
 buildFormationMaintenanceActiveJobSnapshot,
 cloneFormationMaintenanceJob,
 cloneRuntimeMap,
 restoreRuntimeMap,
 restoreRuntimeSet,
 isFormationPlayerFenceConflict,
 isFormationVolatileFallbackAllowed,
 resolveFormationDailySpiritStoneCost,
 resolveFormationRemainingQiBudget,
 resolveFormationRemainingSpiritStoneBudget,
 resolveFormationCombatMaxHp,
 resolveFormationCombatHp,
 setFormationRemainingQiBudget,
 setFormationRemainingSpiritStoneBudget,
 buildRuntimeFormationProjection,
 getRuntimeFormationProjection,
 freezeRuntimeProjection,
 resolveFormationRuntimeVisual,
 resolveFormationAuraPerSpiritStone,
 resolveFormationRefillAuraBudget,
 serializeFormation,
 resolveNextFormationUpdatedAt,
 upsertFormationStateRow,
 lockFormationStateRow,
 assertFormationInstanceLeaseFence,
 deleteFormationStateRow,
 extractFormationSerial,
 normalizeDiskMultiplier,
 resolveInventoryItemInstanceId,
 resolveFormationDiskTier,
 touchRuntimeInstanceRevision,
 dispersePlayerQiSpend,
 touchInstanceRevision,
 normalizePlayerId,
 resolveFormationMaintenanceRate,
 markPlayerRuntimeDirty,
 ensureFormationMaintenanceActiveJobReady,
 formatInteger,
 ensureInstanceFormationStateTable,
 findFormationProtectedPlacementConflict,
} = formation_helpers;
...
class WorldRuntimeFormationService {
 ...
 buildCreateFormationPlan(playerId, payload, deps) {
  ...
  const formationStrengthBonusRate = Math.max(0, resolvePlayerCraftEffectStat(player, 'formation', 'outputRate'));
  const hasSetupPayload = payload?.setup && typeof payload.setup === 'object';
  const plan = hasSetupPayload
   ? resolveFormationSetupPlan(template, diskMultiplier, payload.setup, formationSkillLevel, formationStrengthBonusRate)
   : null;
  ...
  const allocation = plan
   ? { ...plan.setup, formationSkillLevel, formationStrengthBonusRate }
   : { ...normalizeFormationAllocation(payload?.allocation), formationSkillLevel, formationStrengthBonusRate };
  const stats = plan ? plan.stats : resolveFormationStats(template, spiritStoneCount, diskMultiplier, allocation, formationSkillLevel, formationStrengthBonusRate);
...
export { ensureFormationMaintenanceActiveJobReady } from './world-runtime-formation.helpers';
