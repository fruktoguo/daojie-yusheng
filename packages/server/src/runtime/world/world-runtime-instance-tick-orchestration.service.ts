...
export class WorldRuntimeInstanceTickOrchestrationService {
 ...
 async advanceFrame(
  ...
  const reusableTickResult = { completedBuildings: [] as any[], transfers: [] as any[], monsterActions: [] as any[], engagedMonsterEvents: [] as any[] };
  ...
  for (const { instance, steps, speed, sleepMonsterAi, isTimeChamber, speedAttribution } of instanceStepPlans) {
   ...
   for (let index = 0; index < steps; index += 1) {
    ...
    reusableTickResult.engagedMonsterEvents.length = 0;
