...
const CHECKS = [
  ...
  {
    id: "network.world_gateway_npc_manual_new",
    category: "目标差距: 性能/扩展",
    description: "禁止 WorldGatewayNpcHelper 回退为手动 new 并持有完整 gateway",
    file: "packages/server/src/network/world.gateway.ts",
    pattern: "new WorldGatewayNpcHelper(this)",
    forbidden: true,
  },
  {
  ...
  {
    id: "network.world_gateway_suggestion_manual_new",
    category: "目标差距: 性能/扩展",
    description: "禁止 WorldGatewaySuggestionHelper 回退为手动 new 并持有完整 gateway",
    file: "packages/server/src/network/world.gateway.ts",
    pattern: "new WorldGatewaySuggestionHelper(this)",
    forbidden: true,
  },
  {
    id: "network.world_gateway_gm_suggestion_manual_new",
    category: "目标差距: 性能/扩展",
    description: "禁止 WorldGatewayGmSuggestionHelper 回退为手动 new 并持有完整 gateway",
    file: "packages/server/src/network/world.gateway.ts",
    pattern: "new WorldGatewayGmSuggestionHelper(this)",
    forbidden: true,
  },
  {
    id: "network.world_gateway_read_model_manual_new",
    category: "目标差距: 性能/扩展",
    description: "禁止 WorldGatewayReadModelHelper 回退为手动 new 并持有完整 gateway",
    file: "packages/server/src/network/world.gateway.ts",
    pattern: "new WorldGatewayReadModelHelper(this)",
    forbidden: true,
  },
  {
    id: "network.world_gateway_presence_manual_new",
    category: "目标差距: 性能/扩展",
    description: "禁止 WorldGatewayPresenceHelper 回退为手动 new 并持有完整 gateway",
    file: "packages/server/src/network/world.gateway.ts",
    pattern: "new WorldGatewayPresenceHelper(this)",
    forbidden: true,
  },
  {
  ...
  },
  {
    ...
    category: "目标差距: 性能/扩展",
    description: "玩家分域 equipment 行级 upsert 必须通过共享 helper 防止 item_instance_id 跨玩家挪用",
    file: "packages/server/src/persistence/player-domain-persistence.service.ts",
    pattern: "upsertEquipmentSlotRowsWithItemInstanceIdRepair(",
    forbidden: false,
    required: true,
  },
  {
    ...
    category: "目标差距: 性能/扩展",
    description: "durable equipment 行级 upsert 必须通过共享 helper 防止 item_instance_id 跨玩家挪用",
    file: "packages/server/src/persistence/durable-operation.service.ts",
    pattern: "upsertEquipmentSlotRowsWithItemInstanceIdRepair(",
    forbidden: false,
    required: true,
  ...
  {
    id: "persistence.asset_identity.equipment_owner_guard_helper",
    category: "目标差距: 性能/扩展",
    description: "equipment 行级 upsert helper 必须保留 owner guard，跨玩家 item_instance_id 冲突不得被挪用",
    file: "packages/server/src/persistence/compat/item-instance-id-compat.ts",
    pattern: "WHERE player_equipment_slot.player_id = EXCLUDED.player_id",
    forbidden: false,
    required: true,
  },
  {
