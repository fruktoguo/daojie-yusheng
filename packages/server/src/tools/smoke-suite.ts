...
const smokeCases = [
  ...
  { name: 'mineral-drop-algorithm', scriptFile: 'mineral-drop-algorithm-smoke.js', standalone: true },
  { name: 'mining-vein-debuff', scriptFile: 'mining-vein-debuff-smoke.js', standalone: true },
  ...
  { name: 'formation-maintenance-job-handoff', scriptFile: 'formation-maintenance-job-handoff-smoke.js', standalone: true },
    ...
    { name: 'invitation-activity', scriptFile: 'invitation-activity-smoke.js', standalone: true },
