  ...
  const sellerPlayer = {
    ...
    inventory: {
      items: [
        ...
        { itemId: 'pill.test_heal', count: 5, name: '测试丹药', itemInstanceId: 'seller-pill', type: 'consumable', tags: ['消耗品', '丹药'] },
        { itemId: 'seed.test_herb', count: 3, name: '测试种子', itemInstanceId: 'seller-seed', type: 'consumable', tags: ['消耗品', '种子'] },
        { itemId: 'map.test_area', count: 1, name: '测试地图', itemInstanceId: 'seller-map', type: 'consumable', tags: ['消耗品', '地图'] },
