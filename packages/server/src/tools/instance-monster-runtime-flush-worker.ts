...
async function main(): Promise<void> {
  ...
  assertFullAppFlushWorkerAllowed('instance-monster-runtime-flush-worker');
  ...
  const { InstanceMonsterRuntimeFlushWorker } = await import('../runtime/world/worker/instance-monster-runtime-flush.worker.js');
