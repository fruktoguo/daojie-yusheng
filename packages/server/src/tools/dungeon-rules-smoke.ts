...
assert.equal(Number(multipliers.allAttributeMultiplier.toFixed(8)), Number((1.2 ** 2).toFixed(8)));
assert.equal(Number(multipliers.hpMultiplier.toFixed(8)), Number((1.2 ** 2 * 2 ** 2).toFixed(8)));
