...
async function main(): Promise<void> {
  ...
  assertFullAppFlushWorkerAllowed('instance-container-flush-worker');
  ...
  const { InstanceContainerFlushWorker } = await import('../runtime/world/worker/instance-container-flush.worker.js');
