...
async function main() {
  ...
  assert.equal(allocationCostBoosted.dailyActiveSpiritStoneCost, allocationCostBase.dailyActiveSpiritStoneCost);
  assert.ok(allocationCostBoosted.effectValue > allocationCostBase.effectValue);
