        ...
        <div class="editor-card">
          ...
          <div class="editor-grid compact">
            ...
            <label class="editor-field">
              <span>物品页码</span>
              <select data-mail-item-page="${options.scope}.${index}"${catalogActionDisabled}>
                ${optionsMarkup(
            ...
            <label class="editor-field wide">
              <span>物品模板</span>
              <select data-mail-bind="${options.scope}.attachments.${index}.itemId"${catalogActionDisabled}>
      ...
      <div class="editor-card">
        ...
        ${item ? getItemEditorControls(`equipment.${slot}`, item, 'equipment') : `
          ...
          <div class="editor-grid compact">
            <label class="editor-field wide">
              <span>装备模板</span>
              <select data-catalog-select="equipment" data-slot="${slot}"${catalogActionDisabled}>
      ...
      <div class="editor-section-head">
        ...
        <div class="button-row">
          ...
          <label class="editor-field" style="min-width: 260px;">
            <span>新增物品</span>
            <select data-catalog-select="inventory-item"${catalogActionDisabled}>
