...
export const PLAYER_REALM_CONFIG: Record<PlayerRealmStage, RealmConfig> = {
  ...
  [PlayerRealmStage.GoldenCore]: {
    ...
    shortName: '金丹前',
    path: 'immortal',
    narrative: '金丹初结，灵光内照，神识大涨，已入修仙中坚之列。',
    progressToNext: 2000,
  ...
  [PlayerRealmStage.BodyIntegration]: {
    ...
    shortName: '合体前',
    path: 'immortal',
    narrative: '天人合一，肉身与元神彻底融合，已是顶尖大能。',
  ...
  [PlayerRealmStage.Mahayana]: {
    ...
    shortName: '大乘前',
    path: 'immortal',
    narrative: '大乘初成，已是人间绝巅，渡劫飞升指日可待。',
