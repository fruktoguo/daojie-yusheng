...
/**
 * tilePatches：NEXT_S2C_MapStatic 内部字段。
 */
...
/**
 * inv：NEXT_S2C_PanelDelta 内部字段。
 */

  inv?: NEXT_S2C_PanelInventoryDelta;  
  /**
 * eq：NEXT_S2C_PanelDelta 内部字段。
 */

  eq?: NEXT_S2C_PanelEquipmentDelta;  
  /**
 * tech：NEXT_S2C_PanelDelta 内部字段。
 */

  tech?: NEXT_S2C_PanelTechniqueDelta;  
  /**
 * attr：NEXT_S2C_PanelDelta 内部字段。
 */

  attr?: NEXT_S2C_PanelAttrDelta;  
  /**
 * act：NEXT_S2C_PanelDelta 内部字段。
 */

  act?: NEXT_S2C_PanelActionDelta;  
  /**
 * buff：NEXT_S2C_PanelDelta 内部字段。
 */
...
/**
 * kind：NEXT_S2C_Detail 内部字段。
 */

  kind: 'npc' | 'monster' | 'ground' | 'player' | 'portal' | 'container';  
  /**
 * id：NEXT_S2C_Detail 内部字段。
 */

  id: string;  
  /**
 * error：NEXT_S2C_Detail 内部字段。
 */

  error?: string;  
  /**
 * npc：NEXT_S2C_Detail 内部字段。
 */

  npc?: NEXT_S2C_NpcDetail;  
  /**
 * monster：NEXT_S2C_Detail 内部字段。
 */

  monster?: NEXT_S2C_MonsterDetail;  
  /**
 * player：NEXT_S2C_Detail 内部字段。
 */

  player?: NEXT_S2C_PlayerDetail;  
  /**
 * portal：NEXT_S2C_Detail 内部字段。
 */

  portal?: NEXT_S2C_PortalDetail;  
  /**
 * ground：NEXT_S2C_Detail 内部字段。
 */

  ground?: NEXT_S2C_GroundDetail;  
  /**
 * container：NEXT_S2C_Detail 内部字段。
 */
