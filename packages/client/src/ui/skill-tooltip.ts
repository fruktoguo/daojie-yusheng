...
/** fixedFormulas：定义该变量以承载业务值。 */
  const fixedFormulas: SkillFormula[] = [];
/** percentFormulas：定义该变量以承载业务值。 */
