...
import { createMainDungeonEntrySource } from './main-dungeon-entry-source';
...
export function createMainPanelContext(options: CreateMainPanelContextOptions) {
  ...
  const dungeonEntrySource = createMainDungeonEntrySource({ socket, showToast: callbacks.showToast }); const openDungeonPanel = dungeonEntrySource.openDungeonPanel;
