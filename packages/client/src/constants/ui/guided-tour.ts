...
export const GUIDED_TOUR_FLOWS: GuidedTourFlow[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        titleFallback: '先看懂地图标记',
        bodyKey: 'guided-tour.step.map-icons.body',
        bodyFallback: 'NPC 头顶出现任务标记时，! 表示可接任务，? 表示可交付，... 表示任务正在进行。传送点和楼梯用于跨地图，宝箱、草药、矿脉等资源点可以观察或交互，红色敌对目标通常会进入战斗。',
        placement: 'top',
        prepare: [
          { type: 'set-layout-collapsed', target: 'bottom', collapsed: false, when: 'desktop' },
        ],
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        bodyFallback: '点击凡胎回春散后，右侧会显示等级、品阶、五行匹配、材料、耗时、成功率和单批产出。',
        placement: 'right',
        advanceMode: 'target-click',
      },
      {
    ...
    steps: [
      {
        ...
        titleFallback: '先从任务定位入口',
        bodyKey: 'guided-tour.step.mining-quest-tab.body',
        bodyFallback: '带挖矿引导的任务详情里会出现“打开引导”和“前往目标”。任务导航负责找当前任务地点；本引导用云来镇旧屋矿窖演示入门挖矿路线。',
        placement: 'bottom',
        advanceMode: 'target-click',
        prepare: [
          { type: 'set-layout-collapsed', target: 'right', collapsed: false, when: 'desktop' },
      ...
      },
      {
        ...
        titleFallback: '到云来镇矿井前',
        bodyKey: 'guided-tour.step.mining-town-entrance.body',
        bodyFallback: '云来镇旧屋矿窖入口地标在 (42,17) 附近，实际楼梯传送点在 (38,14)。如果门口石头挡住路线，先在地图上选中石头目标处理掉，再靠近楼梯。',
        placement: 'top',
      },
      {
        ...
        titleFallback: '清掉门口石头',
        bodyKey: 'guided-tour.step.mining-clear-stone.body',
        bodyFallback: '石头和矿脉都属于可受损地块。选中石头后使用强制攻击或可用的采掘操作，服务端会按地块耐久结算；石头被破坏后路线才会打开。',
        placement: 'top',
      },
      {
        ...
        bodyFallback: '点击楼梯传送点会自动寻路；角色站到传送点后会进入云来镇·旧屋矿窖。传送和落点仍由服务端处理，导览不会替你跨图。',
        placement: 'top',
      },
      {
        ...
        bodyFallback: '进入旧屋矿窖后，移动到玄铁矿脉 (10,9) 附近。挖矿按钮只会在附近存在可见矿脉时出现，找不到按钮时先继续靠近或观察目标格。',
        placement: 'top',
      },
      {
        id: 'mining-skill-tab',
